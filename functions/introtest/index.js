 ...
 */
 ...
 module.exports = async function (event, context, logger) {
    logger.info(`Invoking Introtest with payload ${JSON.stringify(event.data || {})}`);
    ...
    try {
        // Insert the record using the SalesforceSDK DataAPI and get the new Record ID
        // from the result
